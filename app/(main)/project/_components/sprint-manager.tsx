...
export default function SprintManager({ sprint, setSprint, sprints, projectId }: ISprintManagerProps) {
  const [status, setStatus] = useState(sprint.status);
  const router = useRouter();
  const searchParams = useSearchParams();

  const { fn: updateStatus, loading, error, data: updatedStatus }: any = useFetch(updateSprintStatus);
