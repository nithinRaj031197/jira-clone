...
interface ISprintCreationFormProps {
  projectTitle: string;
  projectKey: string;
  projectId: string;
  sprintKey: number;
...
export default function SprintCreationForm({ projectTitle, projectKey, projectId, sprintKey }: ISprintCreationFormProps) {
  ...
  const { loading: createSprintLoading, fn: createSprintFn }: any = useFetch(createSprint);
